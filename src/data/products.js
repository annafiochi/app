...
const products = [
  ...
  
    {
      ...
      price: "R$ 7.499,00",
      description:
        "Galaxy AI revolucionário, S Pen integrada e câmera de 200MP para fotos",
      rating: {
        stars: "⭐⭐⭐⭐⭐",
        reviews: 987,
      },
  ...
  
    {
      ...
      price: "R$ 15.999,00",
      description:
        "O Performance profissional com chip M3 Pro, tela Liquid Retina XDR e bateria de longa duração",
      rating: {
        stars: "⭐⭐⭐⭐⭐",
        reviews: 2.156,
      },
  ...
  
    {
      ...
      price: "R$ 6.799,00",
      description:
        "Ultrabook premium com design ultrafino, tela InfinityEdge e performance poderosa",
      rating: {
        stars: "⭐⭐⭐⭐⭐",
        reviews: 543,
      },
  ...
  
    {
      ...
      price: "R$ 4.999,00",
      description:
        "Tablet premium Android com S Pen incluída, tela Dynamic AMOLED 2X resistência à água",
      rating: {
        stars: "⭐⭐⭐⭐⭐",
        reviews: 432,
      },
